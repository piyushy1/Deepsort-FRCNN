...
class Model(nn.Module):
    ...
    def forward(self, image_batch: Tensor,
        ...
        if self.training:
            ...
            # print(proposal_bboxes.shape, "trg")
            ...
            batch_result = self.detection.generate_detections(proposal_bboxes, proposal_classes, proposal_transformers, image_width, image_height)
    ...
    class Detection(nn.Module):
        ...
        def generate_detections(self, proposal_bboxes: Tensor, proposal_classes: Tensor, proposal_transformers: Tensor, image_width: int, image_height: int) -> Tuple[Tensor, Tensor, Tensor, Tensor]:
            ...
            for batch_index in range(batch_size):
                ...
                batch_result.append((all_detection_bboxes, all_detection_classes, all_detection_probs, all_detection_batch_indices))
